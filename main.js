...
async function fetchRecipes() {
  try {
    ...
    querySnapshot.forEach(doc => {
      ...
      li.querySelector('.share-button').addEventListener('click', (event) => {
    ...
    // Add click event listeners to all "Edit" and "Delete" buttons
...
// Fetch and show recipes when the page loads
...
function displayRecipes(recipes) {
  ...
  recipes.forEach(recipe => {
    ...
    li.innerHTML = `
      ...
      <button class="share-button" data-url="${recipeUrl}">Share</button>
    `;
    recipeList.appendChild(li);
  ...
  attachButtonEventListeners();  // Re-attach "Edit" and "Delete" listeners
}
